                                            ...
                                            <div>
                                                {
                                                    activity.form.map(student =>
                                                        <div>
                                                            <div style={{ borderStyle: "solid", borderRadius: "15px" }}>
                                                                <h4>:{student[0]}</h4>
                                                                <br></br>
                                                                <FormControl component="fieldset">
                                                                    ...
                                                                    <FormLabel component="legend">השתתפות במפגש</FormLabel>
                                                                    <RadioGroup row aria-label="position" name={student[0] + " 2"} >
                                                                        <FormControlLabel
                                                                            value="15"
                                                                            control={<Radio color="rgba(60,60,60)" />}
                                                                            label="5"
                                                                    ...
                                                                    <FormLabel component="legend">תרומה למפגש</FormLabel>
                                                                    <RadioGroup row aria-label="position" name={student[0] + " 3"} >
                                                                        <FormControlLabel
                                                                            value="15"
                                                                            control={<Radio color="rgba(60,60,60)" />}
                                                                            label="5"
